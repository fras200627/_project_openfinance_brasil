...
import com.tican.authentication.service.AuthProperties;
import com.tican.authentication.service.JKSProperties;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain authFilterChain(HttpSecurity http) throws Exception {
        http.cors()
            ...
            .and()
            .authorizeRequests()
                .antMatchers("/health", "/actuator/info",  "/swagger*/**", "/v3/api-docs/**")
                    .permitAll()
            .anyRequest()
                .authenticated();
        return http.build();
