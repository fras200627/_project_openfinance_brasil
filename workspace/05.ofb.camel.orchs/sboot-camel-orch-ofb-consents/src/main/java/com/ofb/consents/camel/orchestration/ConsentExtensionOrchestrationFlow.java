...
@Component
public class ConsentExtensionOrchestrationFlow extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:consentExtensionOrchestrationFlow")
                .routeId("consentExtensionOrchestrationFlow")
                .tracing()
