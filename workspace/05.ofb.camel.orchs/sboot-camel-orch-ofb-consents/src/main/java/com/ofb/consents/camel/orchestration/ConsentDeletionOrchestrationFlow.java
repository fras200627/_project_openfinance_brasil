...
@Component
public class ConsentDeletionOrchestrationFlow extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:consentDeletionOrchestrationFlow")
                .routeId("consentDeletionOrchestrationFlow")
                .tracing()
