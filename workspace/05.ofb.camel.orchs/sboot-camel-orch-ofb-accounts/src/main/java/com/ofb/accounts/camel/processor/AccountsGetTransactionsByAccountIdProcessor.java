...
@Component
@Slf4j
public class AccountsGetTransactionsByAccountIdProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        ///
        com.ofb.accounts.client.accounts.model.ResponseAccountTransactions responseAccountTransactions =
                accountsApi.accountsGetAccountsAccountIdTransactions(resourcesAuthorisedList.get(0).getResourceId(),
        ...
        ///
        exchange.getMessage().setBody(responseAccountTransactions);
    }
