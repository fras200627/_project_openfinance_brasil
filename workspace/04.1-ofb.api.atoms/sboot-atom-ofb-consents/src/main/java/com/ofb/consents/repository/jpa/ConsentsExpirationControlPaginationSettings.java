...
public record ConsentsExpirationControlPaginationSettings(
    ...
    public static Pageable PaginationSettingsTemplate(ConsentsExpirationControlPaginationSettings pageSettings, String fixField) {
        return PageRequest
