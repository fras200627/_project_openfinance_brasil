...
public enum EnumPersonalOtherDocumentType {
  ...
  EnumPersonalOtherDocumentType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EnumPersonalOtherDocumentType fromValue(String value) {
    for (EnumPersonalOtherDocumentType b : EnumPersonalOtherDocumentType.values()) {
