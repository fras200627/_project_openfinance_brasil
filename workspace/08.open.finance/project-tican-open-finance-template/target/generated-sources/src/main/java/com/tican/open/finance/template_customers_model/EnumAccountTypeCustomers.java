...
public enum EnumAccountTypeCustomers {
  ...
  EnumAccountTypeCustomers(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EnumAccountTypeCustomers fromValue(String value) {
    for (EnumAccountTypeCustomers b : EnumAccountTypeCustomers.values()) {
