...
public enum EnumOccupationMainCodeType {
  ...
  EnumOccupationMainCodeType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EnumOccupationMainCodeType fromValue(String value) {
    for (EnumOccupationMainCodeType b : EnumOccupationMainCodeType.values()) {
