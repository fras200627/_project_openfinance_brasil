...
public enum EnumFiliationType {
  ...
  EnumFiliationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EnumFiliationType fromValue(String value) {
    for (EnumFiliationType b : EnumFiliationType.values()) {
