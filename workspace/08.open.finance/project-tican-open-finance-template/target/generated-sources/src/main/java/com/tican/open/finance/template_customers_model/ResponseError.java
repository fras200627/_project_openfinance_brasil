...
import com.tican.open.finance.template_customers_model.ResponseErrorErrorsInner;
...
public class ResponseError {
   ...
   */
  public ResponseError(List<@Valid ResponseErrorErrorsInner> errors, @Nullable Meta meta) {
      this.errors = errors;
      this.meta = meta;
  }
