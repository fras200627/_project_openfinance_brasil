...
@Schema(name = "MetaExtensions", description = "Meta informações referente à API requisitada.")
...
public class MetaExtensions {
   ...
   */
  public MetaExtensions(Integer totalRecords, Integer totalPages, OffsetDateTime requestDateTime) {
    this.totalRecords = totalRecords;
    this.totalPages = totalPages;
    this.requestDateTime = requestDateTime;
  }

  public MetaExtensions totalRecords(Integer totalRecords) {
    this.totalRecords = totalRecords;
    return this;
  }
  ...
  public MetaExtensions totalPages(Integer totalPages) {
    this.totalPages = totalPages;
    return this;
  }
  ...
  public MetaExtensions requestDateTime(OffsetDateTime requestDateTime) {
    this.requestDateTime = requestDateTime;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetaExtensions metaExtensions = (MetaExtensions) o;
    return Objects.equals(this.totalRecords, metaExtensions.totalRecords) &&
        Objects.equals(this.totalPages, metaExtensions.totalPages) &&
        Objects.equals(this.requestDateTime, metaExtensions.requestDateTime);
  }
  ...
  public static class Builder {
    ...
    private MetaExtensions instance;

    public Builder() {
      this(new MetaExtensions());
    }

    protected Builder(MetaExtensions instance) {
      this.instance = instance;
    }

    protected Builder copyOf(MetaExtensions value) { 
    ...
    public MetaExtensions.Builder totalRecords(Integer totalRecords) {
      this.instance.totalRecords(totalRecords);
      return this;
    }
    
    public MetaExtensions.Builder totalPages(Integer totalPages) {
      this.instance.totalPages(totalPages);
      return this;
    }
    
    public MetaExtensions.Builder requestDateTime(OffsetDateTime requestDateTime) {
      this.instance.requestDateTime(requestDateTime);
      return this;
    }
    
    /**
    * returns a built MetaExtensions instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public MetaExtensions build() {
      try {
  ...
  */
  public static MetaExtensions.Builder builder() {
    return new MetaExtensions.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public MetaExtensions.Builder toBuilder() {
    MetaExtensions.Builder builder = new MetaExtensions.Builder();
