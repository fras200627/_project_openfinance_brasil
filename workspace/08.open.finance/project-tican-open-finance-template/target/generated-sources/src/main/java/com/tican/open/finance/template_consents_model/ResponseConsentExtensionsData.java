...
@JsonTypeName("ResponseConsentExtensions_data")
...
public class ResponseConsentExtensionsData {
  ...
  public ResponseConsentExtensionsData() {
    super();
  }
   ...
   */
  public ResponseConsentExtensionsData(String consentId, OffsetDateTime creationDateTime, StatusEnum status, OffsetDateTime statusUpdateDateTime, List<PermissionsEnum> permissions) {
   ...
   */
  public ResponseConsentExtensionsData(String consentId, OffsetDateTime creationDateTime, StatusEnum status, OffsetDateTime statusUpdateDateTime, List<PermissionsEnum> permissions, @Nullable OffsetDateTime expirationDateTime) {
      this.consentId = consentId;
      this.creationDateTime = creationDateTime;
      this.status = status;
      this.statusUpdateDateTime = statusUpdateDateTime;
  ...
  public ResponseConsentExtensionsData consentId(String consentId) {
    this.consentId = consentId;
    return this;
  }
  ...
  public ResponseConsentExtensionsData creationDateTime(OffsetDateTime creationDateTime) {
    this.creationDateTime = creationDateTime;
    return this;
  }
  ...
  public ResponseConsentExtensionsData status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ResponseConsentExtensionsData statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    this.statusUpdateDateTime = statusUpdateDateTime;
    return this;
  }
  ...
  public ResponseConsentExtensionsData permissions(List<PermissionsEnum> permissions) {
    this.permissions = permissions;
    return this;
  }

  public ResponseConsentExtensionsData addPermissionsItem(PermissionsEnum permissionsItem) {
  ...
  public ResponseConsentExtensionsData expirationDateTime(OffsetDateTime expirationDateTime) {
    this.expirationDateTime = expirationDateTime;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResponseConsentExtensionsData responseConsentExtensionsData = (ResponseConsentExtensionsData) o;
    return Objects.equals(this.consentId, responseConsentExtensionsData.consentId) &&
        Objects.equals(this.creationDateTime, responseConsentExtensionsData.creationDateTime) &&
        Objects.equals(this.status, responseConsentExtensionsData.status) &&
        Objects.equals(this.statusUpdateDateTime, responseConsentExtensionsData.statusUpdateDateTime) &&
        Objects.equals(this.permissions, responseConsentExtensionsData.permissions) &&
        Objects.equals(this.expirationDateTime, responseConsentExtensionsData.expirationDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseConsentExtensionsData {\n");
  ...
  public static class Builder {
    ...
    private ResponseConsentExtensionsData instance;

    public Builder() {
      this(new ResponseConsentExtensionsData());
    }

    protected Builder(ResponseConsentExtensionsData instance) {
      this.instance = instance;
    }

    protected Builder copyOf(ResponseConsentExtensionsData value) { 
    ...
    public ResponseConsentExtensionsData.Builder consentId(String consentId) {
      this.instance.consentId(consentId);
      return this;
    }
    
    public ResponseConsentExtensionsData.Builder creationDateTime(OffsetDateTime creationDateTime) {
      this.instance.creationDateTime(creationDateTime);
      return this;
    }
    
    public ResponseConsentExtensionsData.Builder status(StatusEnum status) {
      this.instance.status(status);
      return this;
    }
    
    public ResponseConsentExtensionsData.Builder statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
      this.instance.statusUpdateDateTime(statusUpdateDateTime);
      return this;
    }
    
    public ResponseConsentExtensionsData.Builder permissions(List<PermissionsEnum> permissions) {
      this.instance.permissions(permissions);
      return this;
    }
    
    public ResponseConsentExtensionsData.Builder expirationDateTime(OffsetDateTime expirationDateTime) {
      this.instance.expirationDateTime(expirationDateTime);
      return this;
    }
    
    /**
    * returns a built ResponseConsentExtensionsData instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public ResponseConsentExtensionsData build() {
      try {
  ...
  */
  public static ResponseConsentExtensionsData.Builder builder() {
    return new ResponseConsentExtensionsData.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ResponseConsentExtensionsData.Builder toBuilder() {
    ResponseConsentExtensionsData.Builder builder = new ResponseConsentExtensionsData.Builder();
