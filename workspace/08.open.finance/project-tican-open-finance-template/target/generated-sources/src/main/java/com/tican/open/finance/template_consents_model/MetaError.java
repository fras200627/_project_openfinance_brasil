...
@Schema(name = "MetaError", description = "Meta informações referente à API requisitada.")
...
public class MetaError {
   ...
   */
  public MetaError(OffsetDateTime requestDateTime) {
    this.requestDateTime = requestDateTime;
  }

  public MetaError requestDateTime(OffsetDateTime requestDateTime) {
    this.requestDateTime = requestDateTime;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestDateTime, metaError.requestDateTime);
  }
  ...
  public static class Builder {
    ...
    protected Builder(MetaError instance) {
      this.instance = instance;
    }

    protected Builder copyOf(MetaError value) { 
      this.instance.setRequestDateTime(value.requestDateTime);
      return this;
    }

    public MetaError.Builder requestDateTime(OffsetDateTime requestDateTime) {
      this.instance.requestDateTime(requestDateTime);
      return this;
    }
    
    /**
    * returns a built MetaError instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public MetaError build() {
      try {
  ...
  */
  public static MetaError.Builder builder() {
    return new MetaError.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public MetaError.Builder toBuilder() {
    MetaError.Builder builder = new MetaError.Builder();
