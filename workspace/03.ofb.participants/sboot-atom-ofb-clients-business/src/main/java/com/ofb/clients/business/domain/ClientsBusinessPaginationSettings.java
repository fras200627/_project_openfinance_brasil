...
public record ClientsBusinessPaginationSettings(
    ...
    public static Pageable PaginationSettingsTemplate(ClientsBusinessPaginationSettings pageSettings, String fixField) {
        return PageRequest
