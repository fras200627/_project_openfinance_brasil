...
import com.tican.oauth2.users.domain.UserRecordCreate;
import com.tican.oauth2.users.domain.UserRecordUpdate;
...
public class UserEntity implements UserDetails {
    ...
    public UserEntity(UserRecordCreate request) {
        this.id         = null;
    ...
    public UserEntity(UserRecordUpdate request) {
        this.id         = request.id();
        this.name       = request.name().trim();
        this.email      = request.email().trim();
        this.type       = request.type();
