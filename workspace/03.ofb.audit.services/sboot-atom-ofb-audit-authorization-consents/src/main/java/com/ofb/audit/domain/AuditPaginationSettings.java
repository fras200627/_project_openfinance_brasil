...
public record AuditPaginationSettings(
        ...
        @Nullable @Pattern(regexp = "ticket|requestUri|requestMethod|requestUserName|requestTime")
        String page_sort_field,

        @Nullable @Pattern(regexp = "ASC|DESC")
        String page_sort_order
) {
    public static Pageable PaginationSettingsTemplate(AuditPaginationSettings pageSettings, String fixField) {
        return PageRequest
