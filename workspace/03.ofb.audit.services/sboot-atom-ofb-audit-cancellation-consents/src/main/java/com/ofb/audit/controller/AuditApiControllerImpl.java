...
public class AuditApiControllerImpl implements AuditApiDelegate {
    ...
    @Override
    public ResponseEntity<AuditResponsePageable> getFindByPageable(Long pageNumber, Long pageSize, String pageSortField, String pageSortOrder) {
    ...
    @Override
    public ResponseEntity<AuditResponsePageable> getFindByFilters(Long pageNumber, Long pageSize, String pageSortField, String pageSortOrder, String auditId, String xTicketIdId, String xFapiInteractionId) {
        return AuditApiDelegate.super.getFindByFilters(pageNumber, pageSize, pageSortField, pageSortOrder, auditId, xTicketIdId, xFapiInteractionId);
    }
