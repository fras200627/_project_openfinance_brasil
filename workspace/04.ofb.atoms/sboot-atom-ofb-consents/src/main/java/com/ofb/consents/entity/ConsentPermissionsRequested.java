...
@Entity(name = "ConsentPermissionsRequested")
@Table(schema = "OFB", name = "CONSENTS_PERSONAL_DATA_PERMISSIONS_REQUESTED")
@Data @Builder
@AllArgsConstructor @RequiredArgsConstructor
@EqualsAndHashCode(of= "id")
public class ConsentPermissionsRequested {
    ...
    @Column(name = "CONSENTPERMISSIONREQUESTEDID")
    private Long id;
