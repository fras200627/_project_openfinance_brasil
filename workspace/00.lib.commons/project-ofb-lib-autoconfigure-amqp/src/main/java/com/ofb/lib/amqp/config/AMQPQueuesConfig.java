...
public class AMQPQueuesConfig {
	...
	@Bean
	public Binding bindingHttpRequests(DirectExchange direct, Queue ofbAuditHttpRequestsQueue) {
	...
	@Bean
	public Binding bindingAuditConsentsAuthorization(DirectExchange direct, Queue ofbAuditConsentsAuthorization) {
	...
	@Bean
	public Binding bindingAuditConsentsCancellation(DirectExchange direct, Queue ofbAuditConsentsCancellation) {
	...
	@Bean
	public Binding bindingAuditConsentsRevoke(DirectExchange direct, Queue ofbAuditConsentsRevoked) {
	...
	@Bean
	public Queue ofbAuditConsentsExtends() {
		return new Queue(AUDIT_CONSENTS_EXTENDS_QUEUE);
	}
	
	@Bean
	public Binding bindingAuditConsentExtends(DirectExchange direct, Queue ofbAuditConsentsExtends) {
	...
	@Bean
	public Binding bindingConsentsAuthorization(DirectExchange direct, Queue ofbConsentsAuthorization) {
	...
	@Bean
	public Binding bindingConsentsCancellation(DirectExchange direct, Queue ofbConsentsCancellation) {
