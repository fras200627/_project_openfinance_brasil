package com.ofb.lib.handlers.handler;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ofb.lib.handlers.enums.ResponseOFBCodesEnum;
import com.ofb.lib.handlers.exception.ofb.*;
...
public class RestControllerAdviceHandler {
    ...
    public ResponseEntity handleException(UnprocessedEntityException ex) {
        ...
        return ResponseEntity.unprocessableEntity().body(new ResponseErrorTemplate().toBuilder()
                .errors(errors)
                .meta(meta)
                .build());
    }
    ...
    public ResponseEntity handleException(InternalErrorException ex) {
        String[] messageDetails = ex.getLocalizedMessage().split(":");
        this.writeError(ex.getClass().toString(), ex.getMessage(), messageDetails);
