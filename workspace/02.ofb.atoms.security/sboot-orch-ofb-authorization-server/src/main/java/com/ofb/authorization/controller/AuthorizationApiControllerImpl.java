...
import com.ofb.authorization.service.AccessTokenClaimsValidationService;
import com.ofb.authorization.service.BusinessEntityValidationService;
import com.ofb.authorization.service.LoggedUserValidationService;
...
public class AuthorizationApiControllerImpl implements AuthorizationApiDelegate {
    ...
    @Autowired
    private AccessTokenClaimsValidationService accessTokenClaimsValidationService;

    @Autowired
    private BusinessEntityValidationService businessEntityValidationService;

    @Autowired
    private LoggedUserValidationService loggedUserValidationService;
