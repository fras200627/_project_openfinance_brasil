package com.ofb.clients.domain.service;

import com.ofb.clients.domain.server.model.*;
import com.ofb.lib.amqp.service.MessageService;
import com.ofb.lib.handlers.exception.BadRequestExceptionHandler;
import com.ofb.clients.domain.entity.OAuth2RegisteredClientsEntity;
import com.ofb.clients.domain.mapper.OAuth2RegisteredClientMapper;
import com.ofb.clients.domain.repository.OAuth2RegisteredClientsRepository;
