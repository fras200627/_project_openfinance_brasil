...
public record AccountTransactionsPaginationSettings(
        ...
        @Nullable
        @Pattern(regexp = "transactionDateTime")
    ...
    public static Pageable PaginationSettingsTemplate(AccountTransactionsPaginationSettings pageSettings, String fixField) {
        return PageRequest
