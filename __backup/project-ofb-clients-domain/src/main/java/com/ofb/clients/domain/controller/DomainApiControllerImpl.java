package com.ofb.clients.domain.controller;

import com.ofb.lib.security.profiles.CanSystemOFBAdmin;
import com.ofb.clients.domain.server.handler.DomainApiDelegate;
import com.ofb.clients.domain.server.model.ClientCreateRecord;
import com.ofb.clients.domain.server.model.ClientUpdateRecord;
import com.ofb.clients.domain.server.model.Code202Template;
import com.ofb.clients.domain.server.model.OAuth2ClientResponse;
import com.ofb.clients.domain.service.OAuth2RegisteredClientsService;
