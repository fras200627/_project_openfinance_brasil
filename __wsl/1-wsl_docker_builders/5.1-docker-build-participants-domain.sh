...
echo "-------------------------------------------------------------------------------------------------"
docker build -t fras200627/tican-oauth2-registered-clients-domain-api:1.0.1-openapi .

echo
echo "-------------------------------------------------------------------------------------------------"
echo "push a image to docker platform"
echo "-------------------------------------------------------------------------------------------------"
docker push fras200627/tican-oauth2-registered-clients-domain-api:1.0.1-openapi
